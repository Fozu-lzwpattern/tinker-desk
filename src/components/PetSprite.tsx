 ...
 *
 * Built-in SVG: Default Tinker (green blob with antenna).
 * Custom themes can be imported via Sprite Studio in Settings.
 *
 * NOTE: Additional built-in SVG themes (Kanga, Pixel, Neko, Bot) were removed
 * to reduce bundle size and improve rendering performance. They remain in git
 * history (commit ef5be45) if needed in the future.
 */
